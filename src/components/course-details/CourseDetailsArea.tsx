          ...
          <div className="row">
            <div className="col-xl-8 wow fadeIn">
              ...
              <h2 className="scourse-title">
                The Complete Web Devoloper Guideline 2024
              </h2>
                ...
                >
                  ...
                  <div className="row pt-2">
                    <div className="col-xl-6 align-self-center">
                      <img
                        src="assets/img/courses/cd2.jpg"
                        className="pb-3"
                        alt="image"
                      />
                    </div>
                  ...
                  <div className="cd_curriculum">
                    ...
                    <ul>
                      ...
                      <li>
                        <span>
                          <a href="#">
                            <i className="bx bx-play-circle"></i> Overview of
                            Editing
                          </a>
                        </span>{" "}
                        <span className="cd_cur_right">
                      ...
                      <li>
                        <span>
                          <a href="#">
                            <i className="bx bx-folder"></i> Basic Editing
                            Technology
                          </a>
                        </span>{" "}
                        <span className="cd_cur_right">
